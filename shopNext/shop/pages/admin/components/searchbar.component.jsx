...
export default function SearchBar({event}) {
    ...
    return(
        <div className="flex bottom-6 right-24 fixed">
            ...
            <input name="search" type="text" className="w-full -ml-10 pl-9 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-purple-500" placeholder="Search..." onChange={e => event(e.target.value, false)}/>
        </div>
    )
}